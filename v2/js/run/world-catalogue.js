...
export const TERRAIN_PACKS = Object.freeze({
  varied:{name:'Mixed Landscapes',range:100,canyon:54,snow:50,ocean:0,flight:32,spacing:116,valley:7,noise:1,weights:{range:5,hills:4,plateau:5,caldera:3,mesa:2,buttes:3,gorge:4,grand:3,forest:3,dunes:3,ravine:2,crevice:2,basin:2,volcano:2,valley:2,chaos:2,spine:2,labyrinth:2,impact:2,yardangs:2,drumlins:2,fan:2,karst:2,spiral:2,blades:2,spider:2,cells:2,stripes:2,escarpment:2,canyon:2,grotto:2,sky:1,skyreef:1,skycrown:1,skyshards:1,caverns:2,delta:2,arcade:2,cuesta:2,crescents:2,dome:2,pedestals:2,honeycomb:2,wave:2,scablands:2,box:2,kame:2,atoll:2,ribbons:2,oxbow:2,shields:2,kettles:2,fulgurite:2,catena:2,coil:2}},
  ...
  canyon:{name:'Deep Canyons',range:18,canyon:150,snow:70,ocean:-.32,flight:32,spacing:190,valley:9,noise:.25,weights:{grand:9,gorge:6,crevice:4,ravine:4,labyrinth:4,box:4,oxbow:3,spider:3,karst:3}},
  ...
  badlands:{name:'Badlands',range:82,canyon:70,snow:60,ocean:-.1,flight:38,spacing:126,valley:8,noise:.55,weights:{buttes:8,plateau:6,mesa:5,cuesta:6,arcade:5,fan:3,box:4,pedestals:4,honeycomb:3}},
  karst:{name:'Underworld Galleries',range:60,canyon:105,snow:80,ocean:-.14,flight:38,spacing:150,valley:8,noise:.15,weights:{caverns:14,grotto:10,arcade:7,box:2}},
  geothermal:{name:'Meteor Marches',range:28,canyon:85,snow:95,ocean:-.18,flight:32,spacing:128,valley:8,noise:.12,weights:{catena:18,impact:8,scablands:5,chaos:2}},
  glacial:{name:'Spiral Terrace Country',range:82,canyon:65,snow:45,ocean:-.12,flight:48,spacing:175,valley:8,noise:.15,weights:{coil:16,spiral:10,kame:3}},
  ...
  sky:{name:'Aerial Kingdoms',range:85,canyon:45,snow:90,ocean:.1,flight:60,spacing:160,valley:8,noise:.1,weights:{sky:7,skyreef:5,skycrown:5,skyshards:5,ribbons:10}},
});
...
export const NEW_PLANET_THEMES = Object.freeze({
  titanforest:{name:'Titan Forest',orbit:.94,wetness:.36,activity:.13,pack:'karst',coverage:.72,biomes:['redwood','bamboo','cloudforest','woodland'],water:0x335f65,shore:0x829f79,weights:{forest:12,valley:9,grotto:7,plateau:6},note:'Giant forest canopies above cave corridors and fallen fossil bridges.'},
  bloomsanctuary:{name:'Bloom Sanctuary',orbit:1,wetness:.08,activity:.06,pack:'badlands',coverage:.4,biomes:['cherry','meadow','autumn','cloudforest'],water:0x648ea7,shore:0xdbbdb5,weights:{plateau:12,mesa:6,hills:6,arcade:7,fan:4},note:'Pink blossom terraces and copper foothills around pale open courts.'},
  sulfurfurnace:{name:'Sulfur Furnace',orbit:.63,wetness:-.58,activity:.96,pack:'varied',coverage:1,exclusive:true,biomes:['sulfur','obsidian','volcanic'],water:0x9b812c,shore:0xd3bd43,weights:{shields:8,volcano:12,caldera:4,stripes:4},note:'Yellow mineral fields, black shields and scattered erupting vents.'},
  ...
  skyarchipelago:{name:'Sky Archipelago',orbit:1.14,wetness:.17,activity:.16,pack:'sky',coverage:1,biomes:['aurora','cloudforest','lichen'],water:0x5878ab,shore:0xb3c0d9,exclusive:true,weights:{sky:8,skyreef:7,skycrown:7,skyshards:7,ribbons:14},note:'Detached high slabs and luminous groves above misty lowland basins.'},
  fossil:{name:'Fossil World',orbit:1.21,wetness:-.37,activity:.05,pack:'badlands',coverage:.8,biomes:['salt','obsidian','lichen'],water:0x60757d,shore:0xcbbca3,weights:{plateau:15,pedestals:9,scablands:7,buttes:5},note:'Bleached fallen trunks and mushroom rock caps over charcoal and ivory ground.'},
  copperharvest:{name:'Copper Harvest',orbit:1.03,wetness:-.09,activity:.14,pack:'badlands',coverage:.55,biomes:['autumn','baobab','sponge','savanna'],water:0x607962,shore:0xceaa67,weights:{cuesta:10,kame:8,arcade:7,mesa:5},note:'Amber step country, bottle trees and hollow sponge colonies on climbing benches.'},
