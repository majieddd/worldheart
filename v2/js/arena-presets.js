...
export const GRAPHICS_ORIGINAL=Object.freeze({line:1.4,fog:.0115,shadowDepth:.10,saturation:1.16,texture:1,exposure:1,resolution:1.25,fov:78,bob:.35,shake:.45,sensitivity:1});
...
export const GRAPHICS_PRESETS=Object.freeze({
  ink132:Object.freeze({name:'Painted-Anime-Inkline 1.3.2',graphics:Object.freeze({line:1.81,fog:.0225,shadowDepth:.35,saturation:1.3,texture:1.5,exposure:.77,resolution:1.25,fov:81,bob:.45,shake:.45,sensitivity:1})}),
  default:Object.freeze({name:'1.3.1 original',graphics:GRAPHICS_ORIGINAL}),
  vivid:Object.freeze({name:'Vivid paint',graphics:Object.freeze({line:2.8,fog:.0225,shadowDepth:.35,saturation:1.3,texture:1.5,exposure:.77,resolution:1.25,fov:81,bob:.45,shake:.45,sensitivity:1})}),
...
// The owner changed the demo default, not the preserved 1.3.1 recipe.
export const DEFAULT_PRESET='ink132';
export const GRAPHICS_DEFAULTS=GRAPHICS_PRESETS[DEFAULT_PRESET].graphics;
...
export const ART_DIRECTION_VERSION='1.3.2';
