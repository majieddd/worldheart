...
async function build() {
  ...
  const audioAssets={};
  for(const file of (await readdir(join(root,'audio'))).sort())if(file.endsWith('.mp3'))audioAssets[file]='data:audio/mpeg;base64,'+(await readFile(join(root,'audio',file))).toString('base64');
