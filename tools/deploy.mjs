...
const TREES = ['js', 'css', 'lib', 'audio', 'art-candidates', 'design-demos/99-planets'];
const FILES = ['index.html','debug.html','lobby.html','audio-lab.html','style-lab.html','painted-lab.html','hard-cel-lab.html','style-playground.html','atmospheric-arena.html','asset-stage.html','artboard.html','procgen-lab.html','generation-lab.html','99-art.html','99-factions.html'];
...
function sameContent(a, b) {
  ...
  if (/\.(wav|mp3|ogg|flac|png|jpg|jpeg|webp|glb|zip)$/i.test(a)||relative(ROOT,a).replaceAll('\\','/').startsWith('art-candidates/hard-cel-v1/')) return readFileSync(a).equals(readFileSync(b));
