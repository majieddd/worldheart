...
const previewPath = path => (path === 'index.html' || path === 'debug.html' || path === 'lobby.html' || path === 'audio-lab.html' || path === 'style-lab.html' || path === 'painted-lab.html' || path === 'hard-cel-lab.html') || /^(js|css|lib|audio|art-candidates)\//.test(path);
