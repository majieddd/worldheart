...
try{
  if(process.argv.includes('--first-expedition')){
    await (await import('./probes/first-expedition.mjs')).run({page,browser,base,out,check,settle,errors});
  }else if(process.argv.includes('--99-identity')){
    await (await import('./probes/99-identity.mjs')).run({page,browser,base,out,check,settle,sharp,errors,requests,httpFailures});
  }else if(process.argv.includes('--99-unified')){
    await (await import('./probes/99-unified-artbook.mjs')).run({page,browser,base,out,check,settle,sharp,errors,requests,httpFailures});
  }else if(process.argv.includes('--99-factions')){
    await (await import('./probes/99-factions.mjs')).run({page,browser,base,out,check,settle,sharp,errors,requests,httpFailures});
  }else if(process.argv.includes('--99-art')||process.argv.includes('--99-drafts')){
  ...
  }else if(process.argv.includes('--handling')){
    await (await import('./probes/ink-handling.mjs')).run({page,browser,base,out,check,shot,settle,difference,sharp,errors,requests});
  }else if(process.argv.includes('--stage-motion')){
    await (await import('./probes/ink-motion-review.mjs')).run({page,browser,base,out,check,shot,settle,difference,sharp,errors,requests});
  }else if(process.argv.includes('--asset-stage')){
    await (await import('./probes/ink-asset-stage.mjs')).run({page,browser,base,out,check,shot,settle,difference,sharp,errors,requests});
  }else if(process.argv.includes('--arena-live')){
