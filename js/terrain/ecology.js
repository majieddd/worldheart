...
export function createEcology(seed, key='auto',environment=planetEnvironment((seed>>>0)||1)) {
  ...
  const volcanic=(x,y,z)=>extreme==='volcanic'||(!['frozen','monsoon','oceanic','fungal','crystalline','ferrous','twilight','arid'].includes(extreme)&&tectonic(x*3+19,y*3,z*3)>regime.volcano);
