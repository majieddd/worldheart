...
export const TERRAIN_PACKS = Object.freeze({
  varied:{name:'Mixed Landscapes',range:100,canyon:54,snow:50,ocean:0,flight:32,spacing:116,valley:7,noise:1,weights:{range:5,hills:4,plateau:5,caldera:3,mesa:2,buttes:3,gorge:4,grand:3,forest:3,dunes:3,ravine:2,crevice:2,basin:2,volcano:2,valley:2,chaos:2,spine:2,labyrinth:2,impact:2,yardangs:2,drumlins:2,fan:2,karst:2,spiral:2,blades:2,spider:2,cells:2,stripes:2,escarpment:2,canyon:2,grotto:2,sky:1,caverns:2,delta:2,arcade:2,cuesta:2,crescents:2,dome:2,pedestals:2,honeycomb:2,wave:2,scablands:2,box:2,kame:2,atoll:2,ribbons:2,oxbow:2,shields:2,kettles:2,fulgurite:2,catena:2,coil:2}},
  ...
  sky:{name:'Aerial Kingdoms',range:85,canyon:45,snow:90,ocean:.1,flight:60,spacing:160,valley:8,noise:.1,weights:{sky:14,ribbons:14}},
});
...
export const NEW_PLANET_THEMES = Object.freeze({
  ...
  skyarchipelago:{name:'Sky Archipelago',orbit:1.14,wetness:.17,activity:.16,pack:'sky',coverage:1,biomes:['aurora','cloudforest','lichen'],water:0x5878ab,shore:0xb3c0d9,exclusive:true,weights:{sky:18,ribbons:14},note:'Detached high slabs and luminous groves above misty lowland basins.'},
