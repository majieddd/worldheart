// Seeded 3D simplex noise plus fbm and ridged variants.
...
export function ridged3(noise, x, y, z, octaves = 4, lacunarity = 2.1, gain = 0.52) {
  let sum = 0, amp = 0.62, freq = 1, prev = 1;
  for (let o = 0; o < octaves; o++) {
...
// Easing set from design-forge canvas-motion. t in 0..1.
