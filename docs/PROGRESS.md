...
U250-U252 locally verified, publishing: playable accepted Vey in three painted environments; complete concept/reference-pack pipeline, exact model turnarounds and fitted replay action. 34 pipeline tests and scene/Studio desktop-mobile checks pass. Aegis 3.18.10 published and installed. Generic anatomy fitting and strike animation remain separate. [Evidence, boundaries and timing](qa/implementation/VEY-FIELD-REFERENCE-PIPELINE.md).
