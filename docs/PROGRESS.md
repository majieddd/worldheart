...
U149-U153 on `feature/homeworld-combat-audio`: [home planets, combat audio and workflow](qa/implementation/HOMEWORLD-COMBAT-AUDIO.md). Aegis improvements are pushed and installed. Plasma/blade effects, five approval-only battle arrangements, approved calm-home music, claim/revisit, decoration and incursion checkpoints are implemented. Local audio, home persistence, core tests and complete ten-wave defense pass; 22 home/touch cases pass and V2 publication checks are active. Owner-approved pickup/upgrade/victory and the nine supplied songs remain intact.
