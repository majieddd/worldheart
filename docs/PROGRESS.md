U256-U261 locally verified, publication pending: Codex on `feature/painted-earth`. Production Painted-Anime-Inkline 1.3.2 surfaces and lighting; Earth-first opening, four new paintings and action-led FPS tutorial; wooden walls, explorable supply structures, fewer crystals and versioned Solar relief. 416 tests, 32 opening/touch checks, five map camera regressions, an accelerated 10-wave lifecycle and home autosave/reload pass. [Scope, evidence and acceptance limits](qa/implementation/PAINTED-EARTH.md). Main remains unchanged.
