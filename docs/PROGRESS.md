...
U149-U153 on `feature/homeworld-combat-audio`: [home planets, combat audio and workflow](qa/implementation/HOMEWORLD-COMBAT-AUDIO.md). Aegis improvements are pushed and installed. Plasma/blade effects, five approval-only battle arrangements, approved calm-home music, claim/revisit, decoration and incursion checkpoints are implemented. Local audio, home persistence, core tests and complete ten-wave defense pass; 23 local home/touch cases pass. Initial V2 f0475b7 passed 22 home and 82 audio checks; the final backup-restoration follow-up is being published. Owner-approved pickup/upgrade/victory and the nine supplied songs remain intact.
