...
| `js/game.js` | Placement legality, gold, lives, selection, build/upgrade/sell. |
| `js/waves.js` | The wave director: composition, spawn cadence, pacing. |
...
99 Planets, 30 on the classic maps · 115 tests · 29 ES modules.
...
wave cleared
  ...
  -> frontier widens, enemies may evolve, a tower may unlock
...
silently fell a wave behind per draft and stopped expanding on schedule.
