...
| M5 ocean strategy | active | optional instrumented commander/nest tactics | [Three additional old-rule defeats](qa/implementation/OCEAN-STRATEGY.md), preserved policy corrections; repeat under physical nest rules | unmeasured |
| U22-U27 commander feedback | implemented-awaiting-verification in parallel worktree | tower context, arm/swing, collision, loot preview, physical nests, route lines | [Owner intake](qa/2026-09-06-COMMANDER-REQUEST.md), [issue #19](https://github.com/majieddd/worldheart/issues/19); extra-high agent, feature/commander-feedback | unmeasured |
