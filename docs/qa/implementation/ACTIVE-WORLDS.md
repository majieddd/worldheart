...
| U90 Natural glacial underpass | Verified locally | A coherent low hill bridge with usable top and open trough beneath |
| U91 Cell mosaic | Verified locally | More numerous, narrower cells with usable passages |
| U92 Integrated grotto | Verified locally | Continuous matching rock roof and banks, natural entries and upper surface |
| U93 Active land features | Verified locally | Separate recipe-fit placement after formation/biome layout; flat geyser pockets plus ten researched additions; dedicated Debug lane |
| U94 Disasters and hostility | Verified locally | Theme compatibility, independently seeded hostility increasing its range with campaign progress, ten new working disasters and dedicated Debug lane |
| U95 Fallen trunks | Verified locally | Move from formation catalogue into recipe-fit active features, retaining real traversal |
| U96 Amphitheatre replacement | Verified locally | A completely different formation, not another crater |
| U97 Pedestal integration | Verified locally | Rock mass, stems and caps use a coherent natural shape/material |
| U98 Honeycomb variation | Verified locally | Open central access and seeded variation in spine widths and spacing |
| U99 Deep Canyon profile | Verified locally | Lower positive relief, stronger inward depth, connected dry routes |
| U100 Four distinctive terrain replacements | Verified locally | Replace Karst, Geothermal, Glacial and Sky presets with recognizable terrain recipes and necessary new formations |
| U101 Tundra distinction | Verified locally | Block ice and frozen grasses distinguish it from alpine spires |
| U102 Coherent biome geography | Verified locally | Volcano-adjacent volcanic ecology; theme, geology and coast constrain placement |
| U103 Sky Archipelago | Verified locally | Dominant detached floating land, natural bridges and useful traversal, not ordinary hills |
| U104 All Planet | Verified locally | Oversized showcase world with the full compatible biome/terrain/feature vocabulary |
| U105 Solar system worlds | Verified locally | Earth, Moon, Mars, Venus, Mercury, Jupiter, Saturn, Neptune, Uranus, Titan, Europa, Ganymede, Triton, Io, Callisto and Pluto, researched and visually checked |
...
First checkpoint published as `574d6f4`: [Pages run](https://github.com/majieddd/worldheart/actions/runs/34718977246). `262` public identity checks and `50` public combat checks passed. [Evidence](ACTIVE-WORLDS/COMBAT.md). U90-U105 passed local acceptance; public V2 verification is next. [Environmental checkpoint](ACTIVE-WORLDS/ENVIRONMENT.md).
...
A legal ten-wave defense extracted four items to Planet 2. Public V2
deployment remains in acceptance. All Planet's survey contains all 52 formations,
